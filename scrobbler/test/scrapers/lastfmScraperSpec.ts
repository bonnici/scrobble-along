...
function setupTest(jsonResponseCode: number, jsonResponse: string, username: string, apiKey: string, requireListening?:boolean) {
...
describe('LastfmScraper', () => {
	...
	describe("fetchAndParse", () => {
		...
		it('should return a song if the most recent song is not now playing but it is not required', () => {
			var jsonString =
				'{\
				  "recenttracks": {\
					"track": [\
			...
			var parser = setupTest(200, jsonString, 'username', 'apiKey', true);
			var done = false;
