...
function setupTest(jsonResponseCode, jsonResponse, username, apiKey, requireListening) {
...
describe('LastfmScraper', function () {
    describe("fetchAndParse", function () {
        ...
        it('should return a song if the most recent song is not now playing but it is not required', function () {
            var jsonString = '{\
				  "recenttracks": {\
					"track": [\
					  {\
